...
public class ArticleListAdapterDemo extends CommonAdapter<ArticleInfo> {

    public ArticleListAdapterDemo(Context context, int layoutId, List<ArticleInfo> datas) {
