...
import net.swiftos.utils.CommonUtil;
import net.swiftos.utils.DateUtils;
import net.swiftos.utils.ImageUtils;
import net.swiftos.utils.SDCardUtil;
import net.swiftos.utils.ScreenUtils;
import net.swiftos.utils.StringUtils;
import net.swiftos.view.richtext.RichTextEditor;
 ...
 * 新建笔记
 */
public class NewArticleActivity {
...
//        insertDialog.show();
//
//        subsInsert = rx.Observable.create(new Observable.OnSubscribe<String>() {
//            @Override
//            public void call(Subscriber<? super String> subscriber) {
//                try{
//                    et_new_content.measure(0, 0);
//                    int width = ScreenUtils.getScreenWidth(NewArticleActivity.this);
//                    int height = ScreenUtils.getScreenHeight(NewArticleActivity.this);
